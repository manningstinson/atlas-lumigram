...
import { postService, Post, PostWithFavorite } from '../services/post.service';
...
export default function HomeScreen() {
  ...
  const fetchPosts = async (refresh = false) => {
    ...
    try {
      ...
      const result = await postService.getPosts(refresh ? undefined : lastVisible, PAGE_SIZE);
  ...
  const renderEmptyComponent = () => (
    <View style={styles.emptyContainer}>
      {!isLoading && (
        <>
          <Ionicons name="images-outline" size={64} color={colors.mediumGray} />
